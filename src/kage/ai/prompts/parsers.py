...
def _looks_like_command(line: str) -> bool:
    ...
    command_starters = [
        "nmap", "nikto", "gobuster", "dirb", "ffuf", "wfuzz",
        "sqlmap", "hydra", "john", "hashcat", "metasploit", "msfconsole",
        "curl", "wget", "nc", "netcat", "ssh", "scp", "ftp",
        "grep", "cat", "ls", "cd", "pwd", "find", "locate",
        "python", "python3", "ruby", "perl", "php",
        "sudo", "su", "chmod", "chown", "mkdir", "rm",
        "ping", "traceroute", "dig", "nslookup", "host", "whois",
        "tcpdump", "wireshark", "tshark",
        "searchsploit", "msfvenom", "exploit",
        "$", "#",
    ]
